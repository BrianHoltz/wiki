...
- JAQrabbit: "Just asking questions" without evaluating answers is not truth-seeking. It's cowering behind fake skepticism. Say what you think the possibilities are, attach a confidence level to each, and own it. You can always adjust your probabilities as evidence surfaces.
...
- Defend a record. Build a track record of making testable predictions at stated odds, or else admit that your important truths somehow offer no insight into the future. If the world is structured, so that people, skeptical of your belief will be able to definitely and definitely disagree with you without ever, being surprised by events or evidence, then how can we say that your belief is true?
- Differences in opinion about why things happened or what should happen can persist indefinitely. But disagreements about what actually happened are rare and unstable or fragile. If you have a contrary belief about what has actually happened, you should say by when will your belief become a consensus? What example can you give where there is a contrarian version about what has happened (not just interpretation of its meaning or motivation) that endures indefinitely. The only examples are religion and that should tell you something.
- Believe seriously: If you were right, what markets would move? What investments would be different? What whistles would blow? What opponents would protest? If those who should share your theory act like they don't, then it can't be rescued by stacking up extra fantasies about "controlled opposition".
...
- What headline could announce that your conspiracy has been proved wrong? That's about as imaginable as a headline saying that some gods had been proven not to exist. So how is UFO belief different from a religion? When a belief is based on quantity over quality, it is pretty much unfalsifiable. There is nothing that can significantly shrink the pile of half-baked evidence after the pile's size has convinced the believer. Their belief is debunk-proof because it is evidence-proof -- i.e. safe from contradiction by any possible new evidence. We skeptics of the two dozen paranormal phenomena listed above could be proved wrong on any of them tomorrow morning.
...
- piles of evidence do not count. If there are 1000 data points and you agree that none of them are particularly strong then you cannot say that at least one or two of them must be correct. Because if there is a pattern that demonstrates that the overwhelming majority of them must be incorrect, then it is so much more likely that all of them incorrect than it is that some unidentified, one or two of them are actually true, but we just don't know which ones.
