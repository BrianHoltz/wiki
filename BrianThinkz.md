...
- Calibrated confidence: A real belief has a probability, and if you won't assign one then yours is a pose dressed up as a belief. Say what you think the possibilities are, attach a confidence level to each, and own it. Refusing to assess probability is not humility — it's a tell. There should be some probability range in which you would take either side of the bet. Betting is a tax on bullshit. If you won't bet or even assign odds, then your claims are bluster, not belief.
