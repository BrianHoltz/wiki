...
- Defend a record. Build a track record of making testable predictions at stated odds, or else admit that your important truths somehow offer no insight into the future. If your theory somehow never makes a prediction that surprises a skeptic, it's not a belief -- it's a bunker.
- Convergence clock: Disputes about what actually happened don't linger, because evidence eventually forces resolution. If your contrarian factual claim has no convergence in sight, it isn't a hypothesis to interpret evidence — it's a faith to shelter you from it.
