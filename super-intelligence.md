...
* Positives
  * Good movie script
  * Chernobyl, Mars probes
  * Computer security: thin, didn't mention Morris Worm
  * Midgley (didn't mention he was killed by a 3rd invention)
  * Radium Girls
* Anthropomorphic AI
* Fast Take-Off
* Analogies
  ...
  * Alphafold
  * space probes
  * Chernobyl: fast take-off. Assumes self-amplification that's faster than humans can react.
  * computer security
  * alchemy
  * Titanic
  * evolution
  ...
  * 1100 nuclear plant
  * world war 2
  * mental super-soldiers: Captain Algebra
  * Vesna Vulović
  * nuclear war (Arkhipov)
  * gods of smallpox, hominids, etc
  * humans as statues
* Discontinuous Reveal
* Uninterrupted Scaling
* No Deception/Misperception Among AIs
* Artificial Betterness
* ASI:humans::humans:ants
