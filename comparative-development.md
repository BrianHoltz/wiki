...
* Libertarian Critique:
    * **Public Choice & Data Quality:** "Age heaping" in 19th-century Census data may reflect enumerator incentives (apathy, bias) rather than subject numeracy; "state capacity" measures often capture bureaucratic effort, not just population ability.
    * **Institutional Barriers:** Attributing gaps to "deep roots" ignores massive state-imposed constraints (e.g., anti-literacy laws, occupational licensing) that artificially suppressed human capital accumulation and distorted economic signals.
    * **Signaling vs. Productivity:** "Numeracy" (exact age reporting) may be a signal of bureaucratic conformity in industrializing states rather than a proxy for marginal economic productivity in agrarian contexts.
    * **Omitted Variable Bias:** Admixture correlates with heritable *cultural capital* (legal knowledge, social networks, wealth) as much as genetics; these non-genetic factors are crucial for navigating post-colonial institutions.
    * **Selection Effects:** Migration patterns (e.g., Mexico vs. Peru) are driven by institutional incentives (rent-seeking vs. trade); outcome differences reflect risk preferences and institutional fit, not just raw cognitive variance.
    * **Methodological Individualism:** Aggregating vast populations into racial means obscures individual marginal decision-making; this approach risks a collectivist fallacy that treats groups, rather than individuals, as the primary economic actors.
    * **Dynamic Incentives:** Claims of 150-year stability ignore the changing *returns* to skills (Skill-Biased Technical Change); in free markets, comparative advantage allows for integration regardless of absolute group averages.
    * **Fragility of Proxies:** Regressing noisy 1820s data on modern test scores relies on fragile "growth econometrics" chains; statistical significance in such cross-country comparisons is often sensitive to model specification.
    * **Fatalism vs. Markets:** A "deep roots" focus risks fatalism; a libertarian perspective emphasizes that removing state barriers allows spontaneous order to utilize diverse human capital more effectively than top-down planning.
    * **Multidimensional Discrimination:** Dismissing environmental factors based solely on skin tone ("colorism") misses other vectors of discrimination (class markers, speech, lineage) that correlate with admixture but are socially reinforced.
* Expert Critique:
    * **Validity of Historical Proxies:** Agreements that age heaping is a clever and widely accepted proxy for historical numeracy in economic history (A'Hearn, Baten, Crayen), though its precision at the individual level versus regional level is debated.
    * **Admixture Methodology:** Acknowledges the robustness of modern genomic studies (e.g., Fuerst & Hu) showing correlations between European ancestry and cognitive scores, but notes that correlation does not definitively prove a genetic causal mechanism without controlling for subtle environmental confounders associated with ancestry.
    * **Environmental Confounders:** Disagreements on the dismissal of environmental factors; a neutral expert would argue that admixture often covaries with unmeasured familial wealth, cultural capital, and differential treatment beyond just skin color (which the text dismisses too easily).
    * **Selection Bias in Historical Data:** Criticism of the assumption that historical populations (e.g., soldiers, census respondents) are representative; survivorship bias and selection into "literate" or "soldier" categories can skew group comparisons significantly.
    * **Causal leaps:** Skepticism regarding the leap from "historical numeracy gaps existed" to "these gaps are genetic and immutable." Historical persistence is consistent with both genetic transmission and deep-seated cultural/institutional transmission (dual inheritance theory).
    * **Range Restriction Issues:** Agrees with the text's own caveat about range restriction in literacy/numeracy data (ceiling effects for Whites) but argues this makes standardized effect size comparisons (SD gaps) potentially unstable and less comparable to modern IQ gaps than claimed.
    * **Inquisition Data:** Finds the use of Inquisition data to be an innovative but anecdotal source; while qualitative evidence of Sephardic numeracy is compelling, generalizing from a persecuted, highly selected sub-population to broad "Deep Roots" claims is statistically risky.
    * **Puerto Rican Anomalies:** Notes that the text itself admits the Puerto Rican data (where darker individuals sometimes scored higher) doesn't fit the simple "more European = smarter" model, suggesting the genetic hypothesis is not as universal or clean as implied.
    * **Colorism vs. Ancestry:** Would likely argue that the text creates a false dichotomy between "colorism" and "ancestry"; social stratification in the Americas was based on complex racial caste systems (*castas*) that tracked ancestry closely, making them difficult to disentangle observationally.
    * **Need for Sibling Studies:** Strong agreement with the text's final concession that "dispositive high-powered co-sibling control" studies are needed to truly separate genetic from environmental effects, marking the current conclusions as suggestive rather than definitive.
