...
- **No Fermi Paradox**¹: Either grabby aliens are distant, or this is a simulation by AI about AI's dawn. Why is there something rather than nothing? Because Modal Realism: "real" is indexical, so all possible universes are equally real.
...
- **Steelman First**: Know as much about the smartest opposing position as you do about your own. If you can't articulate the best opposing position, then you care more about vibe and tribe than truth.
...
- **Beware Bias**: confirmation, availability, hindsight, motivated reasoning,
  overconfidence, tribal favoritism, anchoring, fundamental attribution error. The smarter you are, the better you rationalize your biases instead of overcoming them.
- **Also Assess Answers**: When you're "just asking questions", don't pretend you have no beliefs about possible answers. Don't plant insinuations — they grow into weeds of disinformation, not flowers of truth. If you could defend it, you'd state it instead of imply it.
- **Bet On It**: If your belief doesn't come with odds, then it's a pillow fort to protect you from epistemic accountability. Refusing odds isn't humility — it's a tell. Every belief should have a clearing price, so find the odds where you'd bet against yours. Betting is a tax on bullshit. No odds signals bluster, not belief.
- **Predict It**: Make testable predictions at stated odds, or else admit that your important truths somehow offer no insight into the future. If your theory never makes a prediction that could surprise a skeptic, it's not a belief — it's a bunker.
- **Converge On Facts**: The how and why and who of events can be endlessly debated, but not the what: evidence converges. Is the evidence not converging toward your factual claim? Then you don't have a hypothesis to interpret the evidence, you just have faith to shelter you from it.
...
- 1961 **George Stigler**, *The Economics of Information* (*Journal of Political Economy*): "The dispersion of prices is a measure of the ignorance in the market, and search is accordingly valuable."
...
- 1973 **Michael Spence**, *Job Market Signaling* (*Quarterly Journal of Economics*): "Education, for example, is costly. We refer to these costs as signaling costs. Notice that the individual, in acquiring an education, need not think of himself as signaling."
- 1974 **Anne Krueger**, [*The Political Economy of the Rent-Seeking Society*](https://www.jstor.org/stable/1808883) (*American Economic Review*): coined "rent-seeking" — still the least-bad name for the behavior first identified by **Gordon Tullock**, *The Welfare Costs of Tariffs, Monopolies, and Theft* (*Western Economic Journal*, 1967).
...
- 2007 **Bryan Caplan**, [*The Myth of the Rational Voter*](https://press.princeton.edu/books/paperback/9780691138732/the-myth-of-the-rational-voter): "rational irrationality"
...
- 2016 **Robin Hanson**, [*The Age of Em*](https://ageofem.com/): modeled AGI as societies, not supervillains
