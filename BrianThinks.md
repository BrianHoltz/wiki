...
- Evolutionary psychology: Selfish genes power out-group bias, in-group signaling, reciprocal altruism, parental investment, parent-child conflict, intrasexual competition, resource/fertility attraction, hypergamy, cuckoldry, assortative mating. Sexes are strategies, not teams.
...
- Economic capitalism: Prices are incentive-wrapped signals which subsidies corrupt and bureaucrats can't replace. Green-price the commons, regulate club goods, tax land for public goods, privatize all else. Beware deadweight loss, embrace comparative advantage.
...
- Historical path dependence: Differences among nations and groups start as historical accidents: geographic and climatic endowments -> agriculture and technology diffusion opportunities -> competitive variance in institutions and social/cultural capital -> differences in human capital, values, norms.
...
- Literature first: There is a literature on everything. If you aren't thinking near the frontier of expert discourse, then just admit that you care more about tribe than truth.
- Cognitive rationalism: Human cognition struggles to overcome confirmation bias, availability bias, hindsight bias, motivated reasoning, overconfidence, tribal favoritism, anchoring, fundamental attribution error etc. Assuming you are immune is a sign you are not.
- Believe seriously: Your beliefs have implications — work them out and own them. If your contrarian belief were true, which actors would know it, and how would their behavior differ from what we observe? Governments, markets, institutions, insiders all act on what they believe. If the relevant actors should know your truth but uniformly act like they don't, then your theory is probably wrong, and can't be rescued by piling more theories on top of it.
