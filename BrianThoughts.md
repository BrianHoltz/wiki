...
- **Also Assess Answers:** When you're "just asking questions", don't pretend you have no beliefs about possible answers. Don't plant insinuations — they'll grow into weeds of disinformation, not flowers of truth. If you could defend it, you'd state it instead of imply it.
...
- **Converge On Facts:** The how and why and who of events can be endlessly debated, but not the what: evidence converges. Is the evidence not converging toward your factual claim? Then you don't have a hypothesis to interpret evidence, you just have faith to shelter you from it.
- **Be Falsifiable:** A skeptic of conspiracies and paranormality could at any moment be proved wrong by new evidence. What headline could prove a Believer wrong? Only one: "Global Prank Revealed: Every Witness Recants!" A belief so immune to evidence has a name: religion.
...
- **Declare Your Best**. Make your best argument and see if it holds up. Don't retreat from one argument to the next, not defending any of them. Declare your roster of best arguments up front. Don't desperately call up players from the minor leagues in the middle of the game.
- **Test The Best:** What matters is the quality of the best evidence, not the quantity of the rest. A bigger haystack of claims doesn't imply a needle of truth. As every tested straw again looks like hay, the odds of a needle go down not up.
