...
Hierarchical Enfranchisement²: Rights are properties of beings, not favors from states. Sentience (the capacity for suffering) grants the right against the initiation of cruelty or excessive pain. Personhood (intelligence, autonomy, self-reflective utility systems) grants the right to self-ownership and full agency. This applies regardless of substrate—biological, silicon, or synthetic.
Evictionism and Open Borders²: Enfranchisement respects physical boundaries but forbids force. Abortion is eviction, not murder; a mother may remove a fetus from her "fence line," but may only kill if no non-lethal removal exists. Similarly, a nation's border is a collective fence line; we may regulate the commons, but have no right to initiate force against peaceful migrants or ignore the rights of foreigners.
Taxonomic Stewardship¹: While a species is not a "person," its extinction is a permanent depletion of the terrestrial commons. We owe it to the future to preserve the biological and cultural "source code" of Earth—species and languages—as the raw material for the recursion of consciousness across the cosmos.
...
- **Steelman First**: Know as much about the smartest opposing position as you do about your own. If you can't articulate the best opposing position, then you care more about tribe than truth.
